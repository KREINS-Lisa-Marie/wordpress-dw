...
/*        $recipes = new WP_Query([
        ...
        if($recipes->have_posts()): while($recipes->have_posts()): $recipes->the_post(); */?>
            <article class="recipe">
                <a href="<?php /*= get_the_permalink(); */?>" class="recipe__link">
                    <span class="sro">Découvrir le voyage <?php /*= get_the_title(); */?></span>
                </a>
                <div class="recipe__card">
                    <header class="recipe__head">
                        <h3 class="recipe__title"><?php /*= get_the_title(); */?></h3>
                        <p><time datetime="<?php /*= date('c', $departure = get_field('departure')); */?>"><?php /*= date_i18n('F Y', $departure); */?></time></p>
                    </header>
                    <figure class="recipe__fig">
                        <?php /*= get_the_post_thumbnail(size: 'medium', attr: ['class' => 'recipe__img']); */?>
                    </figure>
                </div>
            </article>
        <?php /*endwhile; else: */?>
